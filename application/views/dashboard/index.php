<div class="container">
    ...
    <a href="<?php echo URL; ?>zlecenia/dodaj"><button type="submit" class="btn btn-default blue-btn">DODAJ ZLECENIE</button></a>
   	<?php
    	}
    	if($this->isBusiness) {
    		// I am a business
    ...
    <br /><a href="<?php echo URL; ?>zlecenia/dodaj"><button type="submit" class="btn btn-default blue-btn">DODAJ ZLECENIE</button></a>
    ...
    <br /><a href="<?php echo URL; ?>fachowcy"><button type="submit" class="btn btn-default blue-btn">DODAJ BIZNES</button></a>
