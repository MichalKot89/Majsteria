        ...
        <!--
          ...
          <div class="col-md-12 col-sm-12 padd-null right-pannel-last">
              ...
              <img src="<?php echo URL; ?>public/images/hand.png" class="center-block right-pannel-last-img" width="58" height="79" alt="hand">
                <p>
                  1. Powiedz nam czego potrzebujesz w kategorii <?php echo $this->data->specialist_name; ?> <br />
                  2. Najlepiej pasujący wykonawcy z kategorii <?php echo $this->data->name; ?> kontaktują się z Tobą <br />
